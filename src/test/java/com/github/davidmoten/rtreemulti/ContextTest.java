...
public class ContextTest {
    ...
    public void testContextIllegalMinChildren() {
        new Context<Object, Geometry>(2, 0, 4, new SelectorMinimalAreaIncrease(),
                new SplitterQuadratic(), Factories.defaultFactory());
    }

    @Test(expected = RuntimeException.class)
    public void testContextIllegalMaxChildren() {
        new Context<Object, Geometry>(2, 1, 2, new SelectorMinimalAreaIncrease(),
                new SplitterQuadratic(), Factories.defaultFactory());
    }

    @Test(expected = RuntimeException.class)
    public void testContextIllegalMinMaxChildren() {
        new Context<Object, Geometry>(2, 4, 3, new SelectorMinimalAreaIncrease(),
                new SplitterQuadratic(), Factories.defaultFactory());
    }

    @Test
    public void testContextLegalChildren() {
        new Context<Object, Geometry>(2, 2, 4, new SelectorMinimalAreaIncrease(),
                new SplitterQuadratic(), Factories.defaultFactory());
    }
    ...
    public void testContextSplitterNullThrowsNPE() {
        new Context<Object, Geometry>(2, 2, 4, new SelectorMinimalAreaIncrease(), null,
                Factories.defaultFactory());
    }
